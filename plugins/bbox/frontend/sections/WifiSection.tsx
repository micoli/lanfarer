...
export default function BboxWifiSection() {
  const routerId = useRouterForPage("wifi");
  const { data: raw } = useBBoxWifiSettings(routerId ?? "bbox-main");
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <BandCard band="2.4 GHz" radio={w.radio["24"]} ssid={w.ssid["24"]} standards={w.standard["24"]} />
        <BandCard band="5 GHz" radio={w.radio["5"]} ssid={w.ssid["5"]} standards={w.standard["5"]} />
      </div>
