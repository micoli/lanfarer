...
export type HaHistoryData = components["schemas"]["HaHistoryData"];
...
export const serverApi = {
  ...
  haHistory(mac: string, days: number): Promise<HaHistoryData> {
    return apiFetch(apiClient.GET("/__ha/history", { params: { query: { mac, days } } }));
  },
};
